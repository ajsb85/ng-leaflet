...
Look at [this first example](http://tombatossals.github.io/angular-leaflet/examples/markers-simple-example.html).
...
We can see an example using all this [here](http://tombatossals.github.io/angular-leaflet/examples/markers-update-example.html).
...
You can see an example of this special label [here](http://tombatossals.github.io/angular-leaflet/examples/markers-label-example.html).
...
You can see an example of Angular content in messages [here](http://tombatossals.github.io/angular-leaflet/examples/markers-angular-template-example.html).
...
By default the markers will be watched, so we can change its properties dynamically, like in [this demo](http://tombatossals.github.io/angular-leaflet/examples/markers-update-example.html).
...
Let's see an example of this feature on [this demo](http://tombatossals.github.io/angular-leaflet/examples/markers-groups-example.html).
...
You can see an example running this [here](http://tombatossals.github.io/angular-leaflet/examples/markers-clustering-without-overlays-example.html)
...
You can see the complete example [here](http://tombatossals.github.io/angular-leaflet/examples/markers-clustering-example.html)
