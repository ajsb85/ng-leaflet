...
We can define also some other defaults, like the default tileLayer url where the tiles will be fetched, or the zoom control position on the map. You can see the list of all the default parameters [here](https://github.com/ajsb85/ng-leaflet/blob/master/src/services/leafletMapDefaults.js#L2).
...
And that's all. A full example of using this attribute can be found [here](http://ajsb85.github.io/ng-leaflet/examples/custom-parameters-example.html).
