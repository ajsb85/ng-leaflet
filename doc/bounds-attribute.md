...
And that's all, we can see how the _$scope.bounds_ object is updated when we are interacting with the map, like [this example](http://ajsb85.github.io/ng-leaflet/examples/bounds-example.html).
